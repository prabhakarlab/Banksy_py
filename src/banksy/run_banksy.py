...
def run_banksy_multiparam(
    ...
    **kwargs,
    ...
    banksy_dict, banksy_matrix = generate_banksy_matrix(
        adata, banksy_dict, lambda_list, max_m, variance_balance=variance_balance
    )
    ...
    for params_name in results_df.index:
        ...
        subplot_sc(ax, adata_temp, key, raw_clusters, num_clusters, title)
