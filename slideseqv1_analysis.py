...
plot_cell_positions(adata, raw_x, raw_y, coord_keys=coord_keys, fig_size=(6, 6))
...
from banksy_utils.plot_utils import (
    plot_DE_genes,
    plot_DE_genes_refined,
...
adata_spatial_filtered, adata_nonspatial_filtered = refine_cell_types(
...
adata_self = plot_DE_genes_refined(
    adata_spatial_filtered, plot_heatmap=False, save_fig=False
)
...
plot_markergene_sets(metagene_df, rctd_coord, rctd_weights, coord_keys, save_fig=False)
