...
# Colors dictionary for plotting figures
colours_dict = {
    "Granular Layer" : "tab:blue",
    "Molecular layer interneurons" : "tab:orange",
    "Interneurons Pvalb" : "tab:orange",
    "Purkinje/Bergmann" : "tab:red",
    "Oligodendrocyte/Polydendrocyte": "yellowgreen",
    "Choroid" : "tab:purple",
    "Choroid Plexus" : "tab:purple"
}
